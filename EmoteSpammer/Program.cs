...
namespace EmoteSpammer
{
    internal class Program
    {
        ...
        private static void Game_OnGameLoad(EventArgs args)
        {
            ...
            Config.SubMenu("On/Off").AddItem(new MenuItem("EmoteToggable", "Toggable Emote")).SetValue(new KeyBind('h', KeyBindType.Toggle));
